    ...
    CF = {
        ...
        "z": {
            ...
            "comment": (
                ...
                "time with mooring knockdown. `process_pings` always keeps "
                "this axis. `average_ensembles` and "
                "`burst_average_ensembles` regrid onto water depth by "
                "default and publish that instead; asked for the transducer "
                "frame they keep this axis and add the bin depth of each "
                "averaging interval as a derived two-dimensional "
                "coordinate. Wherever this axis is published, bin depth is "
                "`xducer_depth` plus this distance for a downlooker and "
                "`xducer_depth` minus it for an uplooker."
            ),
        },
        "u": {
            "long_name": "u",
